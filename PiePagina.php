            ...
            <div class="row">
              <div class="col-md-3 col-xs-6">
                <div class="footer">
                  ...
                  <p>Somos un Hotel con las mejores condiciones para que su estadia sea una de las mejores de su vida.</p>
                  <ul class="footer-links">
                    <li><a href="#"><i class="fa fa-map-marker"></i>Rotonda cristo rey 1c al lago 1/2 al sur</a></li>
                    <li><a href="#"><i class="fa fa-phone"></i>+505-88-880-769</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i>Apellibre95@gmail.com</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col-md-3 col-xs-6">
                <div class="footer">
                  ...
                  <ul class="footer-links">
                    ...
                    <li><a href="#">Polotica y Privacidad</a></li>
